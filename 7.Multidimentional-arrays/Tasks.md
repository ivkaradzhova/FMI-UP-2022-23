...
## 2. задача
Напишете програма донякъде подобна на играта Minesweeper. Като знаем на кои позиции са "бомбите", изведете индексите на всички клетки, които са на максимално разстояние до най-близката "бомба".    
